...
import Nivel from "./nivel2";
import "../../../styles/cursos/curso2.css";

export default function Curso2({ curso }) {
  ...
  const nombreCursoBD = "igualdad_genero";
          ...
          <div className="progress-box mb-5">
            ...
            <div className="mt-2 text-center">
              <small className="text-muted">
                ...
                {/* Cambia la condición para usar mostrarProcesando */}
                {mostrarProcesando && (
