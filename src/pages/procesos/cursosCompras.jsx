...
export default function CoursesCompras() {
  ...
  const cargarCursosDelAPI = async () => {
    try {
      ...
      // Filtrar solo cursos de "Compras" que estén activos
      const cursosDinamicos = (data.data || [])
        .filter(c => c.proceso_name === "Compras" && c.activo)
        .map((c) => ({
          id: c.id,
          name: c.nombre,
          desc: c.descripcion,
      ...
      <div className="container-wide">
        ...
        <div className="text-center mb-5">
          ...
          <h3 className="titulo-pagina">
            Cursos de Compras e Importaciones 
          </h3>
