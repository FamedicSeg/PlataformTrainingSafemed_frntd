...
export default function CoursesSGCS() {
  ...
  const cargarCursosDelAPI = async () => {
    try {
      ...
      // Filtrar solo cursos de "Aseguramiento de la Calidad y Seguridad" que estén activos
      const cursosDinamicos = (data.data || [])
        .filter(c => c.proceso_name === "Aseguramiento de la Calidad y Seguridad" && c.activo)
        .map((c) => ({
          id: c.id,
          name: c.nombre,
          desc: c.descripcion,
      ...
      <div className="container-wide">
        ...
        <div className="text-center mb-5">
          ...
          <h3 className="titulo-pagina">
            Cursos de Aseguramiento de la Calidad y Seguridad
          </h3>
