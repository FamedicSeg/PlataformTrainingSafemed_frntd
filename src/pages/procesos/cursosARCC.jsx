...
export default function CoursesAsuntosRegulatorios() {
  ...
  const cargarCursosDelAPI = async () => {
    try {
      ...
      // Filtrar solo cursos de "Asuntos Regulatorios y Control de Calidad" que estén activos
      const cursosDinamicos = (data.data || [])
        .filter(c => c.proceso_name === "Asuntos Regulatorios y Control de Calidad" && c.activo)
        .map((c) => ({
          id: c.id,
          name: c.nombre,
          desc: c.descripcion,
      ...
      <div className="container-wide">
        ...
        <div className="text-center mb-5">
          ...
          <h3 className="titulo-pagina">
            Cursos de Asuntos Regulatorios y Control de Calidad
          </h3>
