...
export default function CoursesInvestigacionDesarrollo() {
  ...
  const cargarCursosDelAPI = async () => {
    try {
      ...
      // Filtrar solo cursos de "Investigación y Desarrollo" que estén activos
      const cursosDinamicos = (data.data || [])
        .filter(c => c.proceso_name === "Investigación y Desarrollo" && c.activo)
        .map((c) => ({
          id: c.id,
          name: c.nombre,
          desc: c.descripcion,
      ...
      <div className="container-wide">
        ...
        <div className="text-center mb-5">
          ...
          <h3 className="titulo-pagina">
            Cursos de Investigación y Desarrollo
          </h3>
