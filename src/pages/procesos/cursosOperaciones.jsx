...
export default function CoursesOperaciones() {
  ...
  const cargarCursosDelAPI = async () => {
    try {
      ...
      // Filtrar solo cursos de "Operaciones - Produccion" que estén activos
      const cursosDinamicos = (data.data || [])
        .filter(c => c.proceso_name === "Operaciones - Produccion" && c.activo)
        .map((c) => ({
          id: c.id,
          name: c.nombre,
          desc: c.descripcion,
      ...
      <div className="container-wide">
        ...
        <div className="text-center mb-5">
          ...
          <h3 className="titulo-pagina">
            Cursos de Operaciones - Producción
          </h3>
