...
export default function CoursesInfraMantenimiento() {
  ...
  const cargarCursosDelAPI = async () => {
    try {
      ...
      // Filtrar solo cursos de "Infraestructura y Mantenimiento" que estén activos
      const cursosDinamicos = (data.data || [])
        .filter(c => c.proceso_name === "Infraestructura y Mantenimiento" && c.activo)
        .map((c) => ({
          id: c.id,
          name: c.nombre,
          desc: c.descripcion,
      ...
      <div className="container-wide">
        ...
        <div className="text-center mb-5">
          ...
          <h3 className="titulo-pagina">
            Cursos de Infraestructura y Mantenimiento
          </h3>
